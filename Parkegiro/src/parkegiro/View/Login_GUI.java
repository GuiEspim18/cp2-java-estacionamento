...
public class Login_GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mainPane.setBackground(new java.awt.Color(20, 72, 121));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/parkegiro/Images/logo2.png"))); // NOI18N
        jLabel1.setText("  ");
        ...
        setSize(new java.awt.Dimension(325, 244));
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        if (email.getText().length() > 0 && password.getText().length() > 0) {
            if (email.getText().equals("pf@fiap.com.br") && password.getText().equals("123")) {
                JOptionPane.showMessageDialog(null,"\nSeja bem-vindo(a) Fábio!");
                setVisible(false);
                new Home_GUI().setVisible(true);
            } else {
                JOptionPane.showMessageDialog(null,"\nEmail ou senha incorretos!","ERRO!",0);
            }
        } else {
